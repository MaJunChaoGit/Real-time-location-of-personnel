...
function CHInstance(c, bb, o) {
  ...
  this.container = CesiumHeatmap._getContainer(this.width, this.height, this._id);
  this._options.container = this.container;
  this._heatmap = h337.create(this._options);
  this.container.children[0].setAttribute("id", this._id + "-hm");
}
