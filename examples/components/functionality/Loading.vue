        ...
        <figure>
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 136 166" xml:space="preserve">
            ...
            <g clip-path="url(#outer)">
              ...
              <circle id="hier" fill="rgba(155, 218, 241, 0.2)" cx="50" cy="50" r="35" style="filter:url(#light_Blur);"/>
              <g class="vehicles">
            ...
            <defs>
              ...
              fx="50%" fy="50%">
                <stop offset="30%" style="stop-opacity:0.4"/>
                <stop offset="80%" style="stop-color:rgb(20, 20, 20);
                stop-opacity:0.2"/>
